...
from login.models import MonthPCPMSales
    ...
    if request.method == 'POST':
        ...
        try:
            if request.user.is_authenticated:
                ...
                sales_data=MonthPCPMSales.objects.filter(Division=request.user.userprofile.Division,Head_Quarter=request.user.userprofile.Head_Quarter)
            else:
                pass
            if request.user.is_authenticated and request.user.userprofile.Design =='BM':
                context={'name':request.user.first_name,
            'profile': request.user.userprofile,'data': data,'sales_data':sales_data
            }
